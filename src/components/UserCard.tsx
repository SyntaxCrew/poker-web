import { clearUsers } from "../firebase/poker";
...
export default function UserCard(props: {roomID: string, userUUID: string, displayName: string, estimatePoint?: string, isShowEstimates: boolean, allowOthersToDeleteEstimates: boolean}) {
    return (
        <div className="flex flex-col items-center">
            <div className={"group min-w-12 h-20 rounded-md flex items-center ease-in duration-200 preserve-3d relative " + (props.estimatePoint == null ? 'bg-white' : props.isShowEstimates ? 'rotate-y-180 bg-white text-blue-600' : 'bg-blue-600')}>
